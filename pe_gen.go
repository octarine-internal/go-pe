...
func NewPeProfile() *PeProfile {
    ...
    self := &PeProfile{0,4,20,24,0,4,8,0,4,0,2,4,0,2,0,2,4,6,0,2,4,6,0,2,4,6,0,2,4,6,0,4,6,4,0,4,6,8,4,0,20,4,12,60,0,28,36,32,16,12,20,24,4,0,0,0,18,0,2,16,4,4,2,0,12,0,4,24,0,64,96,28,0,60,112,24,0,60,0,4,8,14,12,4,16,0,4,0,0,4,4,36,0,20,16,12,0,0,0,0,0,0,0,0,32,36,56,32,36,56,8,16}
    return self
}
